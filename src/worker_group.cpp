...
WorkerGroup::WorkerGroup(unsigned _group_id, const unsigned _thread_count, const std::string& _name)
    : m_group_id(_group_id), m_thread_count(_thread_count), m_workers(NULL), m_name(_name), m_wait_stop(false) {}
